...
LABEL_ENCODER_PATH = 'models/mmjsd_all/label_encoder'
LABEL_DECODER_PATH = 'models/mmjsd_all/label_decoder'

OPTIMUS_BERT_PATH = 'models/mmjsd_all/bert'
OPTIMUS_GPT2_PATH = 'models/mmjsd_all/gpt2'

KBGAT_ENCODER_PATH = 'models/mmjsd_all/kbgat_encoder_200'
CONVE_DECODER_PATH = 'models/mmjsd_all/conve_decoder_200'
...
def load_model():
    ...
    mvae_encoder = MultimodalVariationalAutoencoderJSD(
        (
            (bert_encoder, None),
            (kbgat_encoder, None),
        ))

    mvae_label_decoder = MultimodalVariationalAutoencoderJSD(
        (
            (None, label_decoder),
            (None, None),
            (None, None),
    ...
    mvae_text_decoder = MultimodalVariationalAutoencoderJSD(
        (
            (None, gpt2_decoder),
            (None, None),
        ))

    mvae_graph_decoder = MultimodalVariationalAutoencoderJSD(
        (
            (None, None),
            (None, conve_decoder),
        ))

    mvae_passthrough = MultimodalVariationalAutoencoderJSD(
        (
            (None, None),
            (None, None),
        ))
