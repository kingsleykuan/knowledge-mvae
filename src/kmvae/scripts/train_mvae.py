...
LABEL_ENCODER_SAVE_PATH = 'models/mvae_all/label_encoder'
LABEL_DECODER_SAVE_PATH = 'models/mvae_all/label_decoder'

OPTIMUS_BERT_SAVE_PATH = 'models/mvae_all/bert'
OPTIMUS_GPT2_SAVE_PATH = 'models/mvae_all/gpt2'

KBGAT_ENCODER_SAVE_PATH = 'models/mvae_all/kbgat_encoder_200'
CONVE_DECODER_SAVE_PATH = 'models/mvae_all/conve_decoder_200'
...
def load_model(dataset):
    ...
    mvae_train = MultimodalVariationalAutoencoder(
        (
            (None, label_decoder),
    ...
    mvae_val = MultimodalVariationalAutoencoder(
        (
            (None, label_decoder),
            (bert_encoder, None),
            (kbgat_encoder, None),
    ...
    def train_epoch(self):
        ...
        for step, data in enumerate(pbar, start=1):
            ...
            if self.global_step % self.steps_per_log == 0:
                ...
                kl_loss = outputs['mvae_outputs']['kl_loss']
